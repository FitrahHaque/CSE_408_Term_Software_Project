import AdminEvaluationTable from "@/components/AdminEvaluationTable/AdminEvaluationTable";
...
type AdminEvaluatedPageProps = {
    uid: string;
};

const AdminEvaluatedPage: React.FC<AdminEvaluatedPageProps> = ({ uid }) => {
        ...
        <>
            <main className='bg-black min-h-screen'>
                ...
                {user && currentAdmin.uid === uid &&
				    ...
				    flex justify-center uppercase mt-10 mb-5'>{currentAdmin.displayName} Evaluated Problems</h1>
                        <div className='relative overflow-x-auto mx-auto px-6 pb-10'>
                            ...
                            <table className='text-sm text-left text-gray-500 dark:text-gray-400 sm:w-7/12 w-full max-w-[1200px] mx-auto'>
                                ...
                                <AdminEvaluationTable onSetLoadingProblems={setLoadingProblems} uid={currentAdmin.uid} />
                            </table>
                        </div>
                    </div>
...
export default AdminEvaluatedPage;
